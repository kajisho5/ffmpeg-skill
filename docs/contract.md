...
| `skill.version` | the npm / package.json version (`0.15.3`) | any release |
...
```json
{
  ...
  "skill": {"id": "ffmpeg-skill", "version": "0.15.3", "execution_mode": "local", "kind": "execution",
...
`provides` lists these 39 tools by a cross-repository Capability id, for
