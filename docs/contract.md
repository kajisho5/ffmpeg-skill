...
| `skill.version` | the npm / package.json version (`0.13.0`) | any release |
...
```json
{
  ...
  "skill": {"id": "ffmpeg-skill", "version": "0.13.0", "execution_mode": "local", "kind": "execution",
...
`provides` lists these 29 tools by a cross-repository Capability id, for
