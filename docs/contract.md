...
| `skill.version` | the npm / package.json version (`2.2.2`) | any release |
...
```json
{
  ...
  "skill": {"id": "ffmpeg-skill", "version": "2.2.2", "execution_mode": "local", "kind": "execution",
