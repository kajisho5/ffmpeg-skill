...
| `skill.version` | the npm / package.json version (`0.14.0`) | any release |
...
```json
{
  ...
  "skill": {"id": "ffmpeg-skill", "version": "0.14.0", "execution_mode": "local", "kind": "execution",
...
`provides` lists these 34 tools by a cross-repository Capability id, for
